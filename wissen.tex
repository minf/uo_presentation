...
\frame{
  ...
  Anwendung des individuellen Intelligenzbegriffs auf Unternehmen

  \begin{columns}

  \column{0.5\textwidth}
  \begin{enumerate}
    \item Kognitive Intelligenz: Wahrnehmung, Lernen, Gestaltung d. Umwelt% Informationsaufnahme, Bewertung, schlussfolgerndes Denken, Lernen aus Erfahrung, Bewältigung neuer Situationen und optimale Gestaltung der Umwelt
    \item Soziale Intelligenz: Nach innen und außen gerichtet% Intern, im Bezug auf Mitarbeiter und extern, im Bezug auf Kunden, Lieferanten und Umwelt
    \item Technische Intelligenz: Materielle, räumliche und technologische Beschaffenheit des Unternehmens
  \end{enumerate}

  \column{0.4\textwidth}
  \includegraphics[width=1\textwidth]{images/intelligentes-unternehmen.png}

  \end{columns}

  \begin{itemize}
    \item Harmonisierung vorhandenen Wissens $\rightarrow$ Unternehmensidentität
    \item Wissenslogistik als Rahmenbed. zur Nutzung des Wissens
  \end{itemize}
}
...
%        \item ``Wissen ist Macht'' überwinden
    ...
    \column{0.4\textwidth}
      ...
      \vspace{-0.5cm}
      \hspace{0.5cm}\includegraphics[width=0.8\textwidth]{images/serverfault.png}\\
  \end{columns}
}
...
\frame{
  ...
  \begin{itemize}
    \item Es gibt explizites und implizites Wissen
    \item Stärkeren Fokus auf implizites Wissen legen
    \item Wissensaustausch und persönliches Engagement der Mitarbeiter fördern
    \item ``(individuelles) Wissen ist Macht'' überwinden
    \item Theorien:
    \begin{itemize}
      \item Bausteine d. Wissensmanagements (Probst)
      \item Verhaltenskomponenten \& Arbeitsbereiche d. Wissensmanagements (Franken)
      \item Intelligentes Unternehmen
    \end{itemize} 
  \end{itemize}
