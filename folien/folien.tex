...
\newcommand{\includecoveredgraphics}[2][]{%
    \ifthenelse{\the\beamer@coveringdepth=1}{%
        \tikz{
          \begin{scope}[opacity=0.15,transparency group]
...
\title{Lernen im Unternehmen}
\author{Benjamin Vetter (benjamin.vetter@haw-hamburg.de)}
\institute[Hochschule für Angewandte Wissenschaften Hamburg]{Hochschule für Angewandte Wissenschaften Hamburg \newline Fakultät Technik und Informatik}
\date{Stand: \today}
...
\frame{
  \frametitle{Fahrplan des Vortrags}
...
\frame{
  \frametitle{Schnell ist nicht schnell genug}
...
% NICHT VERGESSEN: Kernthese, die aus dem Vortrag mitgenommen werden soll!
...
\section{Organisationale Lerntheorien}
