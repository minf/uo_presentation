...
\frame{
  ...
  \begin{itemize}
    ...
    \item Diskrepanzen stimulieren Lernprozesse
...
\frame{
  ...
  \begin{enumerate}
    ...
    \item Das Unternehmen als Individuum
    \item Organisationale Lerntheorien
    \begin{enumerate}
      \item Cyert, March: Erinnert an behavioristischen Ansatz (adaptiv, passiv)
      \item Argyris, Schön: Konstruktivistischer Ansatz (auch passiv, anspruchsvoll)
    ...
    \end{enumerate}
    \item Theorien vermitteln Ansätze, aber ungenügend um konkrete praktische Handlungskriterien daraus zu extrahieren
